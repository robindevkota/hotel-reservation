...
import {
  ...
  UtensilsCrossed, Wine, BarChart3, ClipboardList,
} from 'lucide-react';
import {
            ...
            {statsLoading ? (
              ...
              <>
                ...
                <div style={{ marginBottom: '2.5rem' }}>
                  ...
                  <AdminTable headers={['Item', 'Section', 'Servings', 'Limiting Factor', 'Revenue (NPR)', 'COGS (NPR)', 'Profit (NPR)', 'Status']} minWidth={900}>
            ...
            {logs.map(log => {
              ...
              return (
                <AdminRow key={log._id}>
                  ...
                  <AdminTd>
                    <span style={{ background: tc.bg, color: tc.color, fontFamily: A.cinzel, fontSize: '0.6rem', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '0.25rem 0.65rem', fontWeight: 700 }}>{log.type}</span>
                  </AdminTd>
