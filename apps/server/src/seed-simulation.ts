...
async function seed() {
  ...
  const categories = await RoomCategory.insertMany([
    { name: 'Superior King Room',   slug: 'superior-king-room',   icon: 'BedDouble', basePrice: 250,  description: 'Elegant rooms featuring a plush king-size bed, refined furnishings, and modern comforts.' },
    { name: 'Superior Twin Room',   slug: 'superior-twin-room',   icon: 'Bed',       basePrice: 230,  description: 'Generously proportioned rooms with two separate double beds.' },
    { name: 'Executive Suite Twin', slug: 'executive-suite-twin', icon: 'Star',      basePrice: 480,  description: 'A distinguished executive suite with twin double beds and a separate living area.' },
    { name: 'Deluxe King Suite',    slug: 'deluxe-king-suite',    icon: 'Gem',       basePrice: 620,  description: 'Opulent suites on the premier floor centered on a grand king bed with sweeping views.' },
    { name: 'Junior Suite',         slug: 'junior-suite',         icon: 'Sparkles',  basePrice: 390,  description: 'A thoughtfully designed junior suite blending a sleeping space with a cosy sitting area.' },
    { name: 'Suite with City View', slug: 'suite-city-view',      icon: 'Building2', basePrice: 550,  description: 'Floor-to-ceiling panoramas of the city skyline with bespoke furnishings.' },
    { name: 'Presidential Suite',   slug: 'presidential-suite',   icon: 'Crown',     basePrice: 1200, description: 'An expansive museum-quality residence with private dining and round-the-clock butler service.' },
  ]);
  console.log(`✅ ${categories.length} room categories`);

  // ── 4. Rooms (27 rooms) ───────────────────────────────────────────────────
  const roomDefs = [
    { name: 'Superior King Room 101',   type: 'superior-king-room',   price: 250,  sqm: 32,  cap: 2, room: '101', floor: 1 },
    { name: 'Superior King Room 102',   type: 'superior-king-room',   price: 250,  sqm: 32,  cap: 2, room: '102', floor: 1 },
    { name: 'Superior King Room 103',   type: 'superior-king-room',   price: 255,  sqm: 33,  cap: 2, room: '103', floor: 1 },
    { name: 'Superior King Room 104',   type: 'superior-king-room',   price: 255,  sqm: 33,  cap: 2, room: '104', floor: 1 },
    { name: 'Superior King Room 105',   type: 'superior-king-room',   price: 260,  sqm: 34,  cap: 2, room: '105', floor: 1 },
    { name: 'Superior King Room 201',   type: 'superior-king-room',   price: 265,  sqm: 34,  cap: 2, room: '201', floor: 2 },
    { name: 'Superior King Room 202',   type: 'superior-king-room',   price: 265,  sqm: 34,  cap: 2, room: '202', floor: 2 },
    { name: 'Superior King Room 203',   type: 'superior-king-room',   price: 270,  sqm: 35,  cap: 2, room: '203', floor: 2 },
    { name: 'Superior King Room 204',   type: 'superior-king-room',   price: 270,  sqm: 35,  cap: 2, room: '204', floor: 2 },
    { name: 'Superior Twin Room 205',   type: 'superior-twin-room',   price: 230,  sqm: 34,  cap: 2, room: '205', floor: 2 },
    { name: 'Superior King Room 301',   type: 'superior-king-room',   price: 280,  sqm: 36,  cap: 2, room: '301', floor: 3 },
    { name: 'Superior King Room 302',   type: 'superior-king-room',   price: 280,  sqm: 36,  cap: 2, room: '302', floor: 3 },
    { name: 'Superior Twin Room 303',   type: 'superior-twin-room',   price: 245,  sqm: 35,  cap: 2, room: '303', floor: 3 },
    { name: 'Superior Twin Room 304',   type: 'superior-twin-room',   price: 245,  sqm: 35,  cap: 2, room: '304', floor: 3 },
    { name: 'Superior Twin Room 305',   type: 'superior-twin-room',   price: 250,  sqm: 36,  cap: 2, room: '305', floor: 3 },
    { name: 'Junior Suite 306',         type: 'junior-suite',         price: 390,  sqm: 55,  cap: 2, room: '306', floor: 3 },
    { name: 'Presidential Suite 307',   type: 'presidential-suite',   price: 1200, sqm: 140, cap: 4, room: '307', floor: 3 },
    { name: 'Superior King Room 401',   type: 'superior-king-room',   price: 295,  sqm: 37,  cap: 2, room: '401', floor: 4 },
    { name: 'Superior King Room 402',   type: 'superior-king-room',   price: 295,  sqm: 37,  cap: 2, room: '402', floor: 4 },
    { name: 'Superior Twin Room 403',   type: 'superior-twin-room',   price: 260,  sqm: 36,  cap: 2, room: '403', floor: 4 },
    { name: 'Superior Twin Room 404',   type: 'superior-twin-room',   price: 260,  sqm: 36,  cap: 2, room: '404', floor: 4 },
    { name: 'Superior Twin Room 405',   type: 'superior-twin-room',   price: 265,  sqm: 37,  cap: 2, room: '405', floor: 4 },
    { name: 'Executive Suite Twin 501', type: 'executive-suite-twin', price: 480,  sqm: 72,  cap: 2, room: '501', floor: 5 },
    { name: 'Deluxe King Suite 502',    type: 'deluxe-king-suite',    price: 620,  sqm: 90,  cap: 2, room: '502', floor: 5 },
    { name: 'Deluxe King Suite 503',    type: 'deluxe-king-suite',    price: 640,  sqm: 95,  cap: 2, room: '503', floor: 5 },
    { name: 'Deluxe King Suite 504',    type: 'deluxe-king-suite',    price: 660,  sqm: 100, cap: 3, room: '504', floor: 5 },
    { name: 'Suite with City View 505', type: 'suite-city-view',      price: 550,  sqm: 80,  cap: 2, room: '505', floor: 5 },
  ] as const;
  ...
  const rooms = await Room.insertMany(roomDefs.map(r => ({
    ...
    floorNumber: r.floor,
    roomNumber: r.room,
    description: `${r.name} — a premium room on floor ${r.floor}.`,
    amenities: ['King Bed', 'Smart TV', 'Wi-Fi', 'Air Conditioning', 'En-Suite Bathroom', 'Minibar'],
    images: ROOM_IMAGES[r.type === 'superior-king-room' || r.type === 'superior-twin-room' ? 'deluxe' : r.type === 'presidential-suite' || r.type === 'deluxe-king-suite' ? 'royal' : 'suite'] ?? ROOM_IMAGES.suite,
    isAvailable: true,
