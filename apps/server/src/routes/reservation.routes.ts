...
router.post('/walk-in-linked', ...requireStaff, requireAdmin, reservations.walkInLinkedReservation);
...
router.patch('/:id/mark-paid-upfront', ...requireStaff, requireAdmin, reservations.markPaidUpfront);
